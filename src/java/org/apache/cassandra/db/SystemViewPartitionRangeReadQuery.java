...
/**
 * A read query that selects a (part of a) range of partitions of a system view.
 */
public class SystemViewPartitionRangeReadQuery extends SystemViewReadQuery implements PartitionRangeReadQuery
{
    private final DataRange dataRange;

    public static SystemViewPartitionRangeReadQuery create(TableMetadata metadata,
                                                           int nowInSec,
                                                           ...
                                                           DataRange dataRange)
    {
        return new SystemViewPartitionRangeReadQuery(metadata,
                                                     nowInSec,
                                                     columnFilter,
                                                     rowFilter,
                                                     limits,
    ...
    private SystemViewPartitionRangeReadQuery(TableMetadata metadata,
                                              int nowInSec,
                                              ColumnFilter columnFilter,
                                              RowFilter rowFilter,
                                              DataLimits limits,
