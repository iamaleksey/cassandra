...
import static org.apache.cassandra.tcm.serialization.Version.V6;
...
public final class KeyspaceParams
{
    ...
    public static class Serializer implements MetadataSerializer<KeyspaceParams>
    {
        ...
        {
            ReplicationType rtype = version.isAtLeast(V6)
        ...
        {
            return (version.isAtLeast(V6) ? ReplicationType.serializer.serializedSize(t.replicationType, version) : 0) +
