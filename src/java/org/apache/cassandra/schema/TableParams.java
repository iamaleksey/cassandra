...
public final class TableParams
{
    ...
    public enum TableReplicationType
    {
        ...
        private static final MetadataSerializer<TableReplicationType> serializer = new MetadataSerializer<>()
        {
            ...
            {
                return version.isAtLeast(Version.V6) ? BYTE_SIZE : 0;
            }
        };
    }
    ...
    public static class Serializer implements MetadataSerializer<TableParams>
    {
        ...
        public TableParams deserialize(DataInputPlus in, Version version) throws IOException
        {
            ...
            builder.comment(in.readUTF())
                   ...
                   .replicationType(version.isAtLeast(Version.V6) ? TableReplicationType.serializer.deserialize(in, version) : TableReplicationType.legacy);
        ...
        public long serializedSize(TableParams t, Version version)
        {
            return sizeof(t.comment) +
                   ...
                   (version.isAtLeast(Version.V6) ? TableReplicationType.serializer.serializedSize(t.replicationType, version) : 0);
        }
