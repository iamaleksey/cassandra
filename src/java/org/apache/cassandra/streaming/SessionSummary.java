...
public class SessionSummary
{
    ...
    public static IVersionedSerializer<SessionSummary> serializer = new IVersionedSerializer<SessionSummary>()
    {
        ...
        {
            InetAddressAndPort.serializer.serialize(summary.coordinator, out, version);
            InetAddressAndPort.serializer.serialize(summary.peer, out, version);
        ...
        {
            InetAddressAndPort coordinator = InetAddressAndPort.serializer.deserialize(in, version);
            InetAddressAndPort peer = InetAddressAndPort.serializer.deserialize(in, version);
        ...
        {
            long size = 0;
            size += InetAddressAndPort.serializer.serializedSize(summary.coordinator, version);
            size += InetAddressAndPort.serializer.serializedSize(summary.peer, version);
