...
public class Validator implements Runnable
{
    ...
    public void fail()
    {
        ...
        MessagingService.instance().send(Message.out(VALIDATION_RSP, new ValidationResponse(desc)), initiator);
    }
    ...
    public void run()
    {
        ...
        MessagingService.instance().send(Message.out(VALIDATION_RSP, new ValidationResponse(desc, trees)), initiator);
    }
}
