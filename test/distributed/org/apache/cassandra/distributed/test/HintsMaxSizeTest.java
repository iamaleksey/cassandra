...
public class HintsMaxSizeTest extends TestBaseImpl
{
    ...
    public void testMaxHintedHandoffSize() throws Exception
    {
                                           ...
                                           .start(), 2))
        {
            ...
            assertThat(node1.callOnInstance(() -> StorageMetrics.totalHints.getCount())).isLessThan(80000);
    ...
    private void assertHintsSizes(IInvokableInstance node, UUID node2UUID)
    {
        ...
        // there might be small overflow in general, let's cap it to 3MB to be safe
        assertThat(totalHintsSize).isLessThan(3 * 1000 * 1000);
    }

    private static void waitForExistingRoles(IInvokableInstance instance)
    {
