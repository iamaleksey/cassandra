...
public class CustomNowInSecondsTest extends CQLTester
{
    ...
    private static void executeBatch(List<String> queries, int nowInSeconds)
    {
        ClientState cs = ClientState.forInternalCalls();
        QueryState qs = new QueryState(cs);
        ...
        QueryProcessor.instance.processBatch(batch, qs, batchQueryOptions(nowInSeconds), Collections.emptyMap(), System.nanoTime());
    }
